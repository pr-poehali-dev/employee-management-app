  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 text-right">Когда-нибудь здесь будет полезная информация, а пока какая-то фигня, так-как изначально это задумывалось для ГРЛС. Увы и ах. Бум Быц</p>
      </div>
