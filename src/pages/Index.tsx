  ...
  const renderDashboard = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 text-right">Когда-нибудь мы сделаем здесь что-то нужное. Реально нужное. <br>А пока тут будет бесполезная информация. Так как изначально это задумывалась для ГРЛС. <br>Бум дыц</p>
      </div>
